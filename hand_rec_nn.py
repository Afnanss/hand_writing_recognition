# -*- coding: utf-8 -*-
"""Copy of hand_rec_nn.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18fPUMLvXNGrvviRi_muyQHZh6HwIkSTP
"""
...
sample_number = 1
while os.path.isfile(f'sample{sample_number}.png'):
    try:
        img = cv2.imread(f'sample{sample_number}.png', cv2.IMREAD_GRAYSCALE)
